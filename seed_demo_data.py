...
def seed_jobs(conn):
    print("  Seeding jobs…")
    jobs = [
        ('6163L', 'MedShift Technologies',  '7394-PCB-A', 50,  'A', 'B', 'WO-23788'),
        ('8481L', 'Apex Defense Systems',   '8481-MAIN',  25,  'C', 'C', 'WO-24001'),
        ('5520K', 'Vertex Robotics',        '5520-CTRL',  100, 'B', 'A', 'WO-23500'),
        ('9102M', 'Orbit Communications',   '9102-RF',    75,  'A', 'B', 'WO-24200'),
        ('3347P', 'Precision Instruments',  '3347-SENS',  200, 'D', 'D', 'WO-23100'),
        ('7721Q', 'NovaTech Electronics',   '7721-PWR',   30,  'B', 'C', 'WO-24350'),
    ]
...
def seed_inventory(conn):
    ...
    parts = [
        ...
        ('Resistor, 10K 0402',      'RC0402FR-0710KL',    '2302', 2500, 'A1-01', '1', 'PO-10042'),
        ('Resistor, 100R 0402',     'RC0402JR-07100RL',   '2304', 1800, 'A1-02', '1', 'PO-10043'),
        ('Capacitor, 100nF 0402',   'GRM155R71C104KA88D', '2301', 3200, 'A1-03', '2A','PO-10044'),
        ('Capacitor, 10uF 0805',    'GRM21BR61A106KE19L', '2303', 950,  'A2-01', '2A','PO-10045'),
        ('IC, STM32F405RGT6',       'STM32F405RGT6',      '2312', 48,   'B1-01', '3', 'PO-10046'),
        ('IC, LM317T Regulator',    'LM317T',             '2311', 120,  'B1-02', '1', 'PO-10047'),
        ('IC, TPS63060DSCR',        'TPS63060DSCR',       '2310', 75,   'B2-01', '3', 'PO-10048'),
        ('Inductor, 10uH 2520',     'SRR6028-100Y',       '2309', 400,  'C1-01', '1', 'PO-10049'),
        ('LED, Red 0402',           'LTST-C190KRKT',      '2308', 5000, 'C1-02', '1', 'PO-10050'),
        ('LED, Green 0402',         'LTST-C190KGKT',      '2308', 5000, 'C1-02', '1', 'PO-10051'),
        ('Connector, USB-C',        'USB4105-GF-A',       '2307', 200,  'D1-01', '2B','PO-10052'),
        ('Connector, 2-pin 2.54mm', 'TSW-102-07-G-S',     '2306', 800,  'D1-01', '1', 'PO-10053'),
        ('Crystal, 16MHz',          'ABLS-16.000MHZ-B4-T','2305', 150,  'A2-02', '2B','PO-10054'),
        ('Transistor, BSS138',      'BSS138-7-F',         '2304', 600,  'A1-01', '1', 'PO-10055'),
        ('Diode, 1N4148W',          '1N4148W-7-F',        '2303', 1200, 'A1-02', '1', 'PO-10056'),
        ('MOSFET, SI2302',          'SI2302DS-T1-E3',     '2312', 300,  'B1-01', '1', 'PO-10057'),
        ('Op-Amp, MCP6002',         'MCP6002-I/SN',       '2311', 90,   'B1-02', '3', 'PO-10058'),
        ('EEPROM, 24LC256',         '24LC256-I/SN',       '2310', 60,   'C1-01', '3', 'PO-10059'),
        ('Capacitor, 1uF 0603',     'GRM188R61A105KA61D', '2309', 2100, 'A2-01', '2A','PO-10060'),
        ('Resistor, 4.7K 0603',     'RC0603FR-074K7L',    '2308', 1600, 'A1-03', '1', 'PO-10061'),
        ('IC, ESP32-WROOM-32E',     'ESP32-WROOM-32E',    '2312', 35,   'B2-01', '3', 'PO-10062'),
        ('Fuse, 1A 0603',           'F0603FF01000V100',   '2311', 500,  'C1-02', '1', 'PO-10063'),
        ('Button, Tactile 4-pin',   'EVQ-Q2B03W',         '2310', 350,  'D1-01', '1', 'PO-10064'),
        ('Capacitor, 22pF 0402',    'GRM1555C1H220JA01D', '2309', 4000, 'A1-01', '1', 'PO-10065'),
        ('IC, LPC11U68JBD48',       'LPC11U68JBD48',      '2308', 22,   'B1-01', '3', 'PO-10066'),
    ]
